...
{
    /// <inheritdoc />
    public partial class InitialChatMVPSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivateMessages_SenderId_ReceiverId_TimestampUtc",
                table: "PrivateMessages",
                columns: new[] { "SenderId", "ReceiverId", "TimestampUtc" });
